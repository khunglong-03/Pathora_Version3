...
export type TransactionTypeString = "Deposit" | "FullPayment" | "Refund" | "VisaServiceFee" | "PayRemain";
...
// Payment gateway enum — PayOS removed; only Sepay remains
export enum PaymentGatewayEnum {
  Sepay = 2,
}

export type PaymentGatewayString = "Sepay";
...
export interface CreateTransactionPayload {
  ...
  paymentGateway?: PaymentGatewayString; // Deprecated: always "Sepay"
}
...
export interface PaymentTransaction {
  ...
  bookingId: string;
  type: "Deposit" | "FullPayment" | "Refund" | "VisaServiceFee" | "PayRemain";
