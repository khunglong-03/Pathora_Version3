...
const TRANSPORT_ERROR_CODE_MAP: Record<string, string> = {
  ...
  "TourInstanceActivity.ExternalFieldsNotAllowedForGround": "tourInstance.transport.errors.externalFieldsNotAllowedForGround",
  "TourInstanceActivity.GroundFieldsNotAllowedForExternal": "tourInstance.transport.errors.groundFieldsNotAllowedForExternal",
  "TourInstanceActivity.ExternalTransportRequiresTime": "tourInstance.transport.errors.externalTransportRequiresTime",
  "TourInstanceActivity.GroundTransportRequiresVehicle": "tourInstance.transport.errors.groundTransportRequiresVehicle",
  "TourInstanceActivity.CannotChangeTransportTypeWithSupplier": "tourInstance.transport.errors.cannotChangeTransportTypeWithSupplier",
