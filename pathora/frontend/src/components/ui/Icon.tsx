...
import {
  ...
  BuildingsIcon, CalendarIcon, CalendarBlankIcon, CakeIcon, CaretDoubleLeftIcon, CaretDoubleRightIcon,
  ...
  IdentificationCardIcon, ImageIcon, InfoIcon, KeyIcon, ListIcon, LightningIcon, MagnifyingGlassIcon, MapPinIcon, MapTrifoldIcon, MinusIcon, MoneyIcon, MoonIcon, NoteIcon,
  PaperPlaneTiltIcon, PencilSimpleIcon, PercentIcon, PhoneIcon, PlusIcon, PuzzlePieceIcon, QuestionIcon,
  QrCodeIcon, ReceiptIcon, ShareNetworkIcon, ShieldCheckIcon, ShoppingBagIcon, SignOutIcon, SparkleIcon, SquaresFourIcon, StarIcon, SunIcon,
...
const iconMap: Record<string, React.ElementType> = {
  ...
  "heroicons:academic-cap": GraduationCapIcon,
  ...
  "heroicons:shopping-bag": ShoppingBagIcon,
