...
export function BookingImportantInfo({ booking }: BookingImportantInfoProps) {
  return (
    <motion.div 
      ...
      className="bg-blue-50 border border-blue-100 rounded-2xl p-8 lg:p-10 shadow-[0_20px_40px_-15px_rgba(59,130,246,0.1)] relative overflow-hidden group"
    >
      ...
      <div className="flex flex-col gap-6 relative z-10">
        <div className="flex items-center gap-4">
          <div className="flex items-center justify-center size-12 rounded-xl bg-blue-100 text-blue-600 shrink-0">
        ...
        <ul className="flex flex-col gap-4">
          {booking.importantInfo.map((info, idx) => (
            <motion.li 
              ...
              className="flex items-start gap-4 bg-white/50 border border-blue-100/50 p-4 rounded-xl backdrop-blur-sm"
            >
