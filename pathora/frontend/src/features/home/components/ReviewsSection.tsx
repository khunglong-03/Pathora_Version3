          ...
          {displayReviews.map((review, idx) => (
            <ScrollReveal key={idx} delay={idx * 120}>
              ...
              <div className="group rounded-[1.25rem] bg-gray-100/50 dark:bg-white/5 border border-gray-200/40 dark:border-white/8 p-1 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-xl hover:shadow-black/5 hover:-translate-y-1 h-full">
                <div className="rounded-[calc(1.25rem-0.25rem)] bg-white dark:bg-[#1a1a2e] p-6 md:p-8 h-full shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] flex flex-col">
                  {/* Quote mark */}
                  <div className="text-[#fa8b02]/20 text-5xl font-serif leading-none mb-3">&ldquo;</div>
                  ...
                  {/* Divider */}
                  <div className="mt-6 mb-5 h-px bg-gray-100 dark:bg-white/10" />

                  {/* Author */}
                  <div className="flex items-center gap-3">
                    {/* Avatar */}
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#fa8b02] to-[#e67a00] flex items-center justify-center shrink-0 overflow-hidden">
                      {review.userAvatar ? (
