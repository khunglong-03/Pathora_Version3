...
const HeroBanner = () => {
  ...
  return (
    ...
    >
      {/* Left: Text Content */}
      <div className="lg:col-span-5 bg-slate-900 rounded-[1.5rem] p-8 md:p-12 v-stack justify-between relative overflow-hidden group shadow-[0_20px_40px_-15px_rgba(0,0,0,0.2)]">
        ...
        <div className="relative z-10 v-stack items-start gap-6">
          <span className="h-stack items-center gap-1.5 bg-white/10 text-white text-[11px] font-bold px-4 py-1.5 rounded-full uppercase tracking-[0.15em] border border-white/10 backdrop-blur-md">
            <Icon icon="heroicons-outline:shield-check" className="size-3.5 text-[#fa8b02]" />
            {t("landing.policies.transparencyFirst")}
          </span>

          <div className="v-stack gap-4">
            <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold tracking-tighter text-white leading-none" style={{ textWrap: "balance" }}>
        ...
        <div className="relative z-10 mt-12 h-stack items-center gap-2 text-sm font-semibold tracking-wide">
      ...
      {/* Right: Image */}
      <div className="lg:col-span-7 rounded-[1.5rem] relative overflow-hidden group shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] bg-slate-200 border border-slate-200 min-h-[300px] lg:min-h-full">
        <Image
          src={HERO_BG}
          alt="Policies Hero"
          fill
        ...
        />
        <div className="absolute inset-0 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)] border border-white/10 pointer-events-none rounded-[1.5rem]" />
      </div>
    </motion.div>
  );
};
...
const IntroSection = () => {
  const { t } = useTranslation();
  return (
    <motion.div variants={itemVariants} className="bg-white rounded-[1.5rem] border border-slate-200 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] p-6 md:p-8 lg:p-10 v-stack md:h-stack gap-8 items-start md:items-center justify-between">
      <div className="spacer v-stack gap-2">
      ...
      <div className="h-stack items-center gap-4 shrink-0 bg-[#f9fafb] border border-slate-100 rounded-[1.5rem] p-5">
        <div className="size-12 rounded-2xl bg-white shadow-[0_4px_12px_rgba(0,0,0,0.04)] border border-slate-100 h-stack items-center justify-center shrink-0">
...
const PolicyCard = ({ section }: { section: PolicySection }) => {
  return (
    <motion.div variants={itemVariants} className="bg-white rounded-[1.5rem] border border-slate-200 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] p-6 md:p-8 lg:p-10 relative overflow-hidden group hover:border-slate-300 transition-colors duration-300">
      ...
      <div className="relative z-10 v-stack gap-8">
        <div className="h-stack items-center gap-5">
          <div className="size-14 rounded-2xl bg-[#f9fafb] border border-slate-100 h-stack items-center justify-center flex-shrink-0 shadow-[0_4px_12px_rgba(0,0,0,0.02)] group-hover:bg-slate-900 transition-colors duration-300">
        ...
        <ul className="v-stack gap-5">
          {section.items.map((item, idx) => (
            <li key={idx} className="h-stack items-start gap-5 group/item">
...
const PolicyContentLoading = () => (
  <div className="v-stack gap-6 w-full">
    {[1, 2, 3].map((i) => (
      <div key={i} className="bg-white border border-slate-200 rounded-[1.5rem] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] p-6 md:p-8 lg:p-10">
        <div className="animate-pulse v-stack gap-8">
          <div className="h-stack items-center gap-5">
            <div className="size-14 rounded-2xl bg-slate-100 shrink-0" />
            <div className="h-6 bg-slate-100 rounded-lg w-48" />
          </div>
          <div className="v-stack gap-4 pl-19">
...
const PolicyContentEmpty = () => {
  const { t } = useTranslation();
  return (
    <motion.div variants={itemVariants} className="bg-white border border-slate-200 border-dashed rounded-[1.5rem] p-16 v-stack items-center justify-center text-center">
      <div className="size-20 rounded-full bg-[#f9fafb] h-stack items-center justify-center mb-6">
...
const PolicyContentError = ({ message }: { message: string }) => {
  const { t } = useTranslation();
  return (
    <motion.div variants={itemVariants} className="bg-white border border-rose-100 rounded-[1.5rem] shadow-[0_20px_40px_-15px_rgba(225,29,72,0.05)] p-16 v-stack items-center justify-center text-center">
      <div className="size-20 rounded-full bg-rose-50 h-stack items-center justify-center mb-6">
...
const CTABanner = () => {
  const { t } = useTranslation();
  return (
    <motion.div variants={itemVariants} className="bg-[#fa8b02] rounded-[1.5rem] p-8 md:p-12 v-stack md:h-stack items-center justify-between gap-8 relative overflow-hidden group shadow-[0_20px_40px_-15px_rgba(250,139,2,0.3)]">
      ...
      <div className="relative z-10 h-stack items-center gap-6">
        <div className="size-16 rounded-2xl bg-white/20 backdrop-blur-md border border-white/20 h-stack items-center justify-center shrink-0">
      ...
      <Link
        href="/contact"
        className="relative z-10 bg-white text-[#c96c00] font-bold tracking-wide px-8 py-4 rounded-full hover:bg-[#f9fafb] hover:scale-105 active:scale-95 transition-all shadow-[0_8px_20px_-8px_rgba(0,0,0,0.2)] whitespace-nowrap"
      >
...
export const PolicyPage = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-10 v-stack gap-6 md:gap-8">
        <motion.div
          variants={containerVariants}
          initial="hidden"
          animate="visible"
          className="v-stack gap-6 md:gap-8"
        >
          {/* Hero Bento */}
          <HeroBanner />
          ...
          <div className="v-stack gap-6 max-w-4xl mx-auto w-full">
            {loading ? (
