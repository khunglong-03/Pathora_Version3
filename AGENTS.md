...
This project is indexed by GitNexus as **Pathora_Version3** (28660 symbols, 65831 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
