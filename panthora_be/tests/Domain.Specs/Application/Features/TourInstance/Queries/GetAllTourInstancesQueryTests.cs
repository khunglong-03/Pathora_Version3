...
public sealed class GetAllTourInstancesQueryTests
{
    ...
    public void CacheKey_WhenPrincipalsDiffer_ShouldDiffer()
    {
        ...
        var managerAQuery = new GetAllTourInstancesQuery("ha long", TourInstanceStatus.Available, 1, 10, true, null, CurrentUserId: managerAId);
        var managerBQuery = new GetAllTourInstancesQuery("ha long", TourInstanceStatus.Available, 1, 10, true, null, CurrentUserId: managerBId);
    ...
    public void CacheKey_WhenPrincipalMissingOrInvalid_ShouldUseAnonSentinel()
    {
        ...
        var invalidPrincipalQuery = new GetAllTourInstancesQuery(null, null, 1, 10, false, null, CurrentUserId: "not-a-guid");
    ...
    public void CacheKey_ShouldKeepTourInstanceNamespace()
    {
        ...
        var query = new GetAllTourInstancesQuery(null, null, 1, 10, false, null, CurrentUserId: managerId);
