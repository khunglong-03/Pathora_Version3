...
public sealed record AssignAccommodationSupplierCommand(
    ...
    [property: JsonPropertyName("accommodationActivityId")] Guid AccommodationActivityId,
    [property: JsonPropertyName("supplierId")] Guid SupplierId) : ICommand<ErrorOr<Success>>, ICacheInvalidator
{
