...
- Name: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts >> HotelServiceProvider Portal Access >> hotel rooms page shows table when rooms exist
- Location: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts:153:7
