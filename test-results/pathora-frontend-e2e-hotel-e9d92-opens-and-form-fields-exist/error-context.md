...
- Name: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts >> HotelServiceProvider Portal Access >> login modal opens and form fields exist
- Location: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts:45:7
