...
- Name: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts >> HotelServiceProvider Portal Access >> hotel profile page is accessible after login
- Location: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts:103:7
