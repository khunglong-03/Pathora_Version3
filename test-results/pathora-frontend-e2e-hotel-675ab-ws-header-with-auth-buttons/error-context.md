...
- Name: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts >> HotelServiceProvider Portal Access >> landing page loads and shows header with auth buttons
- Location: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts:37:7
