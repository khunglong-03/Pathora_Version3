...
- Name: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts >> HotelServiceProvider Portal Access >> hotel provider quick action links exist on dashboard
- Location: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts:144:7
