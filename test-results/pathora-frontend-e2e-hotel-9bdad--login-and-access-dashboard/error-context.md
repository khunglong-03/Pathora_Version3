...
- Name: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts >> HotelServiceProvider Portal Access >> hotel provider can login and access dashboard
- Location: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts:57:7
