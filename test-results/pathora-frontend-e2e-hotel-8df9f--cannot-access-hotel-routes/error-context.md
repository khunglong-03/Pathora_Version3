...
- Name: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts >> HotelServiceProvider Portal Access >> unauthenticated user cannot access hotel routes
- Location: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts:116:7
