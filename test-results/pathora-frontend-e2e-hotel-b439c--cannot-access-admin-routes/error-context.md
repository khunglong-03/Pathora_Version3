...
- Name: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts >> HotelServiceProvider Portal Access >> hotel provider cannot access admin routes
- Location: pathora\frontend\e2e\hotel-provider\hotel-provider.spec.ts:130:7
